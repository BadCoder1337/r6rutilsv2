    ...
    try {
        ...
        guilds.forEach(async (e) => {
            try {
                ...
                var member = e.member(bot.users.find('id', id));         

                //console.log('!!member.roles.find(id, rolesDB.Diamond): ', !!member.roles.find('id', rolesDB.Diamond));
                
                if (!(rolesDB.diamondStab == 'true' & !!member.roles.find('id', rolesDB.Diamond))) {
